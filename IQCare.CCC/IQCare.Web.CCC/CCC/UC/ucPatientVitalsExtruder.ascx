...
<div style="padding-top: 20px">
    <div style="align-content: center" class="label label-primary">
        <asp:Label ID="lblVitalsDate" runat="server" ClientIDMode="Static" class="control-label text-primary">Date Taken :</asp:Label></div>
    <div class="panel-body" style="border-left: solid gray 1px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-5">
                    <label class="control-label pull-left">Weight (kg)</label></div>
                <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-5">
                    <label class="control-label pull-left">BMI(z)</label></div>
                <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-5">
                    <label class="control-label pull-left">Blood Pressure </label>
                </div>
                <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-5">
                    <label class="control-label pull-left">Temperature (0C)</label></div>
                <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-5">
                    <label class="control-label pull-left">Respiratory Rate</label></div>
                <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-5">
                    <label class="control-label pull-left">Blood Oxygen Saturation</label></div>
                <div class="col-md-3">
...
<div class="col-md-12 form-group">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                <label class="control-label pull-left fa fa-arrow-circle-o-right">Pregnancy Status</label></div>

            <div class="col-md-12 form-group">
                <div class="col-md-12">
                    <asp:Label runat="server" CssClass="control-label pull-left" ID="lblPregnancyStatus"></asp:Label></div>
            </div>

            <div class="col-md-12 form-group">
                <div class="col-md-12">
                    <asp:Label runat="server" CssClass="control-label pull-left" ID="lblLMP"></asp:Label></div>
            </div>

            <div class="col-md-12 form-group">
                <div class="col-md-12">
                    <asp:Label runat="server" CssClass="control-label pull-left" ID="lblEDD"></asp:Label></div>
            </div>
            ...
            <div class="col-md-12">
                <label class="control-label pull-left">Pregnancy Intention Assessment</label>
            </div>
            <div class="col-md-12">
                <hr />
            </div>
            <div class="col-md-12">
                <asp:Label runat="server" CssClass="control-label pull-left" ID="lblPIADate">N/A</asp:Label>
            </div>
            <div class="col-md-12">
                <div class="col-md-12">
                    <hr />
            ...
            <div class="col-md-12">
                <asp:Label runat="server" CssClass="control-label pull-left" ID="lblPregnancyIntention">N/A</asp:Label>
            </div>
